...
function queFrase_10() {
    let respuesta = "";
    const frase_10 = document.getElementById('frase_10');
    const texto_10 = frase_10.value;
    const cantidadVocales = cuentaVocales(texto_10);
    const queFrase_10 = document.getElementById("queFrase_10");
    if (cantidadVocales[0] == 0 && cantidadVocales[1] == 0 && cantidadVocales[2] == 0 && cantidadVocales[3] == 0 && cantidadVocales[4] == 0) {
        respuesta = `En la frase ${texto_10} no aparece ninguna vocal.`;
        queFrase_10.innerHTML = respuesta;
        return false;
    }

    respuesta = `En la frase ${texto_10} tenemos:<br>`;
